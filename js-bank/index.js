...
App.createUser("arthur@email.com", "Isaac Pontes")
App.createUser("lucas@email.com", "Lucas Queiroga")
App.createUser("juliana@email.com", "Juliana Conde")

App.deposit("arthur@email.com", 100)

App.transfer("arthur@email.com", "lucas@email.com", 20)

App.changeLoanFee(10)
App.takeLoan("juliana@email.com", 2000, 24)

console.log(App.findUser("arthur@email.com"))
console.log(App.findUser("arthur@email.com").account)
